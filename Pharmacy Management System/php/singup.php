...
if (isset($_POST['reg_user'])) {
    ...
    if (count($errors) == 0) {
        ...
        $query = "INSERT INTO users (name, username, password, email, role, telefon, image) 
  			  VALUES('$nume', '$username', '$password', '$email', '$rol', '$telefon', '$path')";
...
<form class="formlogin" method="post" action="singup.php" enctype="multipart/form-data">
    <div class="form-group">
        <input type="username" class="form-control" id="exampleInputNume" placeholder="Nume" name="nume" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <input type="username" class="form-control" id="exampleInputEmail1" placeholder="Email" name="email"
               required>
    </div>
    <div class="form-group">
        <input type="username" class="form-control" id="exampleInputRole" placeholder="Farmacist / Asistent" name="rol"
               required>
    </div>
    <div class="form-group">
        <input type="username" class="form-control" id="exampleInputTelefon" placeholder="Telefon" name="telefon"
               required>
    </div>
    <div class="form-group">
